...
{
	Eigen::Vector3d s1_p(0.0,-0.5,0.0);
	Eigen::Vector3d s2_p(0.0,0.5,0.0);

	Eigen::Vector4d p_body(caams::pAA(glm::radians(THETA),
							 Eigen::Vector3d(0.0,0.0,1.0)));
	Eigen::Matrix3d A_body(caams::Ap(p_body));
	Eigen::Vector3d d(0.0,-LENGTH,0.0);
	Eigen::Vector3d r_body(s2_p + d - A_body*s1_p);
	Eigen::Vector3d r_dot_body(0.0,0.0,0.0);
	Eigen::Vector4d p_dot_body(0.0,0.0,0.0,0.0);
